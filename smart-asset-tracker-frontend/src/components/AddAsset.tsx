...
const AddAsset = ({ onAssetAdded }: { onAssetAdded: () => void }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 bg-white text-navy rounded-md shadow-md">
  ...
  <div className="space-y-4">
    ...
    <input
      ...
      required
    />
    <button type="submit" className="bg-orange text-white px-4 py-2 rounded-md hover:bg-black">
      Add Asset
    </button>
  </div>
</form>
